...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 4. Seed All Master Data (Suppliers, Raw Materials, Categories, Menu Items & BOM, Packages, Customers, Delivery Areas)
        $masterDataSeeder = new MasterDataSeeder();
        $masterDataSeeder->run($tenant);
    }
}
